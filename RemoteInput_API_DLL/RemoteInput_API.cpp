...
RemoteInputAPI::RemoteInputAPI()
{
}

#ifdef MACOS

void RemoteInputAPI::PressKey(uint8_t ca)
{
...
void RemoteInputAPI::MouseMovements(CGEventType mouseType, int16_t x, int16_t y, CGMouseButton mouseButton)
{
...
void RemoteInputAPI::MouseScroll(CGEventSourceRef source, int16_t scrollCountX, int16_t scrollCountY)
{
...
void RemoteInputAPI::execute(uint8_t *command)
{
...
#ifdef WINDOWS
void RemoteInputAPI::PressKeyUnicode(uint8_t ca, bool bExtended)
{
...
void RemoteInputAPI::PressKeyOthers(uint8_t ca, bool bExtended)
{
	//Structure for the keyboard event
	INPUT ip;
	//Set up the INPUT structure
...
void RemoteInputAPI::MouseMovements(DWORD dwFlags, int16_t dx, int16_t dy, int16_t mouseData)
{
